...
export const matchSchema = new Schema({
    ...
    home: {type: {id: { type: Number, require: true, default: 0} ,
  name: { type: String, require: true, default: "" },
  logo: { type: String, require: true, default: "" }}, require: true, default: undefined},
    away: {type: {id: { type: Number, require: true, default: 0 },
  name: { type: String, require: true, default: "" },
  logo: { type: String, require: true, default: "" }},require: true, default: undefined},
    goals: {
        type: {
