...
import PredictionsRoutes from "./presentation/prediction.routes.js";
...
export default class PredictionApp {
  ...
  predictionRoutes: PredictionsRoutes;
  ...
  constructor(server: Express) {
    ...
    // ----------------- application layer -----------------
    this.predictionUseCases = new PredictionUseCases(this.predictionDbRepository);

    // ----------------- presentation layer -----------------
    this.predictionController = new PredictionController(this.predictionUseCases);
    this.predictionRoutes = new PredictionsRoutes(this.predictionController, server);
  }
}
